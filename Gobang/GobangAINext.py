...
class Game():
    ...
    def eval_base(self, state):
        ...
        self.eval_base_time += (time() - tic)
        self.eval_base_num += 1
...
class AI(object):
    ...
    def go(self, chessboard):
        ...
        #
        # print('\neval_base_time:', game.eval_base_time)
        # print('eval_base_number:', game.eval_base_num)
        # print('eval_base/number:', game.eval_base_time / max(1, game.eval_base_num))
        #
        # print('\nevaluate_time:', game.evaluate_time)
